<section class="section section-with-shape-divider section-parallax bg-tertiary border-0 m-0" data-plugin-parallax="" data-plugin-options="{&#39;speed&#39;: 1.5, &#39;parallaxHeight&#39;: &#39;110%&#39;, &#39;fadeIn&#39;: true}" data-image-src="'{{ asset('public/modules/theme-business/images/common/background-4.jpg') }}'" style="position: relative; overflow: hidden;">
    <div class="parallax-background fadeIn animated" style="background-image: url('{{ asset('public/modules/theme-business/images/common/background-1.jpg') }}'); background-size: cover; position: absolute; top: 0px; left: 0px; width: 100%; height: 110%; transform: translate3d(0px, 1699.71px, 0px); background-position-x: 50%;">
    </div>
    ...
    <div class="container position-relative z-index-1 pb-5 my-5">
        <div class="appear-animation animated fadeIn appear-animation-visible" data-appear-animation="fadeIn" data-appear-animation-delay="1000" style="animation-delay: 1000ms;">
        ...
        <div class="row justify-content-center justify-content-lg-start pb-5 mb-5">
            <div class="col-md-10 col-lg-6 text-center text-lg-end pe-lg-4 pb-5 mb-5">
                <h1 class="text-color-light font-weight-medium line-height-4 text-10 mb-5 appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300" style="animation-delay: 300ms;">High Quality <span class="font-weight-extra-bold custom-highlight-1 ws-nowrap p-1 customHighlightAnim customHighlightAnimDelay">
                    Computer Servicesss</span> for all type of facilities</h1>
            </div>
        </div>
    </div>
</section>
